...
const db = mysql.createConnection({
  host:
    process.env.DB_HOST ||
    "databaseprojectcloud.ccuz8a00sh3k.us-east-1.rds.amazonaws.com",
  user: process.env.DB_USER || "admin",
  password: process.env.DB_PASSWORD || "adminelkamel",
  database: process.env.DB_NAME || "databaseprojectcloud",
});
